...
// Add TypeScript interfaces to fix type errors
interface Material {
...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function createProgramObject(vertexShader: WebGLShader, fragmentShader: WebGLShader): Program {
    ...
    const splatProgram = createProgramObject(baseVertexShader, splatShader);
    const advectionProgram = createProgramObject(baseVertexShader, advectionShader);
    const divergenceProgram = createProgramObject(baseVertexShader, divergenceShader);
    const curlProgram = createProgramObject(baseVertexShader, curlShader);
    const vorticityProgram = createProgramObject(baseVertexShader, vorticityShader);
    const pressureProgram = createProgramObject(baseVertexShader, pressureShader);
    const gradienSubtractProgram = createProgramObject(
      baseVertexShader,
    ...
    function createFBO(w: number, h: number, internalFormat: number, format: number, type: number | undefined, param: number): FBO {
